...
const Tabs = ({ selectedTab, onChange, allCount, changedCount }) => {
...
const FeatureFlagsScreen = () => {
    ...
    const shownAllFeatureFlags = (0,react.useMemo)(() => Object.keys(flags).reduce((acc, ffname) => {
    ...
    const shownSelectedFeatureFlags = (0,react.useMemo)(() => Object.keys(flags).reduce((acc, ffname) => {
        const isSatisfySearch = !search || ffname.indexOf(search) > -1;
    ...
    return (react.createElement(Container, null,
        react.createElement(Header, { style: { borderBottom: "1px solid rgba(0,0,0,0.05);" } },
            ...
            react.createElement(Tabs, { allCount: Object.keys(shownAllFeatureFlags).length, changedCount: Object.keys(shownSelectedFeatureFlags).length, selectedTab: selectedTab, onChange: setSelectedTab })),
        react.createElement(FlagsList, { featureFlags: shownFeatureFlags, changes: changes, onValueChange: onValueChange }),
