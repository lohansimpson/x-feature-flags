...
const Tabs = ({ selectedTab, onChange, changedCount }) => {
    return (react.createElement(Tabs_Container, null,
        react.createElement(Tab, { onClick: () => onChange('all') },
            react.createElement(TabLabel, { selected: selectedTab === 'all' }, "Features")),
...
const FeatureFlagsScreen = () => {
    ...
    const shownFeatureFlags = (0,react.useMemo)(() => Object.keys(featureFlags).reduce((acc, ffname) => {
    ...
    return (react.createElement(Container, null,
        react.createElement(Header, { style: { borderBottom: "1px solid rgba(0,0,0,0.05);" } },
            ...
            react.createElement(Tabs, { changedCount: Object.keys(changes).length, selectedTab: selectedTab, onChange: setSelectedTab })),
