...
const FeatureFlagsScreen = () => {
    ...
    switch (selectedTab) {
        case "all":
            content = (react.createElement(FlagsList, { featureFlags: shownFlags, changes: changes, onValueChange: changeFlag }));
            break;
        case "changed":
            content = (react.createElement(FlagsList, { featureFlags: shownChanges, changes: changes, onValueChange: changeFlag }));
            break;
        case "subscriptions":
            content = react.createElement("div", null, "Subscriptions");
            break;
    }
    return (react.createElement(Container, null,
        react.createElement(Header, { style: { borderBottom: "1px solid rgba(0,0,0,0.05);" } },
            ...
            react.createElement(Tabs, { allCount: Object.keys(shownFlags).length, changedCount: Object.keys(shownChanges).length, subscriptionsCount: Object.keys({}).length, selectedTab: selectedTab, onChange: setSelectedTab })),
        content,
